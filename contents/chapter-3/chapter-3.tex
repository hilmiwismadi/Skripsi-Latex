...
``Organisasi perlu menyelenggarakan perlindungan terhadap \textit{malware} secara konsisten, mencakup pengendalian risiko, aktivitas pemantauan, dan dokumentasi prosedur yang dapat ditinjau berkala.'' \\
\hline
Pendek Implisit &
...
``Beberapa komputer terinfeksi setelah staf mengunduh lampiran \textit{email} mencurigakan, namun tim keamanan tidak memiliki \textit{log} untuk menelusuri penyebarannya.'' \\
\hline
Panjang Implisit &
...
``Tim keamanan mendeteksi lonjakan aktivitas jaringan mencurigakan, indikasi infeksi perangkat, dan dokumen terenkripsi akibat \textit{phishing}, namun belum memiliki pemantauan dan peringatan dini yang memadai.'' \\
\hline
\end{tabular}
\end{table}
