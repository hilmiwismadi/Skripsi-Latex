...
\centering
\footnotesize
\caption{Struktur Data JSON Basis Pengetahuan (Atribut Deskriptif)}
...
\centering
\footnotesize
\caption{Struktur Data JSON Basis Pengetahuan (Atribut Pendukung \textit{Retrieval})}
\label{tab:json_struktur_retrieval}
\begin{tabular}{|p{3.2cm}|p{4.8cm}|p{4.8cm}|}
\hline
\textbf{Nama Atribut} & \textbf{Penjelasan} & \textbf{Contoh Isian} \\
\hline
