...
\hline
SPLADE &
Menghasilkan representasi \textit{sparse} berbasis Transformer dan ekspansi kosakata sehingga dapat menangkap kecocokan leksikal yang lebih kaya dibanding pencocokan kata kunci murni \cite{formal2021splade} &
...
\begin{description}[leftmargin=3.2em, labelwidth=3.0em, labelsep=0.2em, font=\normalfont]
	...
	\item[$H_1$:] Terdapat perbedaan performa yang signifikan antar konfigurasi proporsi pembobotan skor \textit{dense} dan \textit{sparse} pada metode \textit{hybrid retrieval}, dengan konfigurasi seimbang menghasilkan performa terbaik berdasarkan mayoritas metrik evaluasi.
\end{description}
