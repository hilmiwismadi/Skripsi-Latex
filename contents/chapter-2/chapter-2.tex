...
\centering
\small
\caption{Kontrol Annex A.8 -- \textit{Technological Controls} (lanjutan 3)}
\label{tab:annex_a8_lanjutan3}
\begin{tabular}{|P{1.6cm}|P{5.0cm}|P{6.4cm}|}
\hline
\textbf{Annex ID} & \textbf{Nama Kontrol} & \textbf{Penjelasan Singkat} \\
\hline
...
\centering
\small
\caption{Kontrol Annex A.8 -- \textit{Technological Controls} (lanjutan)}
\label{tab:annex_a8_lanjutan}
\begin{tabular}{|P{1.6cm}|P{5.0cm}|P{6.4cm}|}
\hline
\textbf{Annex ID} & \textbf{Nama Kontrol} & \textbf{Penjelasan Singkat} \\
\hline
