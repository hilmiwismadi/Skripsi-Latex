...
\begin{tabular}{lcccc}
\toprule
Configuration & Hit@3 & Recall@3 & MAP@3 & NDCG@3 \\
\midrule
Dense 0.00 : Sparse 1.00 & 0.961 & 0.485 & 0.407 & 0.525 \\
Dense 0.25 : Sparse 0.75 & 0.948 & 0.506 & 0.437 & 0.549 \\
\textbf{Dense 0.50 : Sparse 0.50} & \textbf{0.935} & \textbf{0.537} & \textbf{0.467} & \textbf{0.575} \\
...
metrics: Recall@3\,=\,0.537, MAP@3\,=\,0.467, and NDCG@3\,=\,0.575.
...
MAP@3    & 46.395 & $< 0.000001$ \\\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{lcccc}
\toprule
Config (Hybrid:CE) & Hit@3 & Recall@3 & MAP@3 & NDCG@3 \\
\midrule
1.00 : 0.00 & 0.935 & 0.537 & 0.467 & 0.575 \\
...
Metric & $\chi^2$ & $p$-value \\
\midrule
Hit Rate & 10.462 & \textbf{0.033} \\
Recall   & 21.245 & \textbf{$< 0.001$} \\
NDCG     & 29.639 & \textbf{$< 0.001$} \\
MAP      & 28.952 & \textbf{$< 0.001$} \\
\bottomrule
\end{tabular}
\end{table}

All four metrics show significant differences
(Table~\ref{tab:fusion_friedman}), confirming that score fusion composition
meaningfully affects both coverage and ranking quality. Rank-sensitive
metrics (NDCG, MAP@3) show the strongest effect ($p < 0.001$).
